...
if drug != 'Select a drug':
    ...
    if len(llm_output) == 0 or pd.isna(llm_output[0]) or llm_output[0] == "":
        ...
        drug_metadata.to_csv("Data/moa_drug_final.csv", index=False)
    else:
...
if st.button("Extract data and Run DESeq2"):
    ...
    with st.spinner("Extracting relevant data from the file..."):
    ...
    with st.spinner("Running DESeq2 analysis.. This will take few minutes..."):
